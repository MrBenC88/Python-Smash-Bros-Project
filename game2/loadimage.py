...
#falcon
sprite[7][0]=[image.load("pictures\\Falcon\\runcaptleft"+str(fa)+".png")for fa in range(5)]
sprite[7][1]=[image.load("pictures\\Falcon\\runcaptright"+str(fa)+".png")for fa in range(5)]
sprite[7][2]=image.load("pictures\\FalconMv\\jumpleft.png")
sprite[7][3]=image.load("pictures\\FalconMv\\jumpright.png")
sprite[7][4]=[image.load("pictures\\FalconMv\\rapidfalconL"+str(fa)+".png")for fa in range(7)]
sprite[7][5]=[image.load("pictures\\FalconMv\\rapidfalconR"+str(fa)+".png")for fa in range(7)]
sprite[7][6]=[image.load("pictures\\FalconMv\\raptorboostleft"+str(fa)+".png")for fa in range(3)]
sprite[7][7]=[image.load("pictures\\FalconMv\\raptorboostright"+str(fa)+".png")for fa in range(3)]
sprite[7][8]=[image.load("pictures\\FalconMv\\falpunchpt"+str(fa)+".png")for fa in range(6)]
sprite[7][9]=[image.load("pictures\\FalconMv\\fpunchleft"+str(fa)+".png")for fa in range(6)]

sprite[7][10]=image.load("pictures\\FalconMv\\captainfalconshowurmoves.png")
sprite[7][11]=image.load("pictures\\FalconMv\\standingcaptL.png")
sprite[7][12]=image.load("pictures\\FalconMv\\standingcaptR.png")
sprite[7][13]=image.load("pictures\\Falcon\\captcrouchl.png")
sprite[7][14]=image.load("pictures\\Falcon\\captcrouchr.png")
